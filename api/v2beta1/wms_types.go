...
type WMSStatus struct {
	...
	// conditions represent the current state of the WMS resource.
...
type WMS struct {
	...
	// spec defines the desired state of WMS
	// +required
	Spec WMSSpec `json:"spec"`

	// status defines the observed state of WMS
	// +optional
	Status WMSStatus `json:"status,omitzero"`
}
